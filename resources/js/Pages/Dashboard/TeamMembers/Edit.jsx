                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`mt-1 block w-full rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white ${errors.name ? 'border-red-500' : ''}`}
                                        />
                                        {errors.name && (
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-1 flex items-center">
                                            ...
                                            <span className="ml-2 text-sm text-gray-500 dark:text-gray-400">
                                                {data.image ? data.image.name : 'Current image will be kept'}
                                            </span>
                                        </div>
                                        {errors.image && (
