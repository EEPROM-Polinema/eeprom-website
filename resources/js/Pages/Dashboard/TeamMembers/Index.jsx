...
function SortableTeamMember({ member }) {
    const {
        attributes,
        listeners,
        setNodeRef,
    ...
    return (
        <div ref={setNodeRef} style={style} className="relative">
            <div className="bg-white dark:bg-gray-700 rounded-lg shadow-md overflow-hidden border border-gray-200 dark:border-gray-600 transition-transform hover:scale-[1.02]">
                <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-600 dark:to-gray-800">
                    ...
                    {/* Drag handle */}
                    <div {...attributes} {...listeners} className="absolute top-2 left-2 p-2 cursor-move bg-white/80 dark:bg-gray-800/80 rounded-full hover:bg-white dark:hover:bg-gray-800 transition-colors">
    ...
    const handleDragEnd = (event) => {
        ...
        if (active.id !== over.id) {
            setMembers((items) => {
                ...
                router.post(route('team-members.reorder'), { orders });
