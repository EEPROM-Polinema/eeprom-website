	...
	return (
		<div className="min-h-screen bg-gray-50 flex flex-col">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex justify-between h-16">
						...
						<div className="hidden md:flex items-center space-x-4">
							...
							<a href="/login" className="text-gray-600 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium">Login</a>
							<a href="/register" className="bg-blue-600 text-white hover:bg-blue-700 px-4 py-2 rounded-md text-sm font-medium">Register</a>
						</div>
						{/* Mobile menu button */}
			...
			<div className="flex-grow">
					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						...
						<div className="mt-10">
							<div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
								{/* Team Member Cards */}
								{[1, 2, 3].map((member) => (
									<div key={member} className="bg-gray-50 rounded-lg shadow-lg overflow-hidden">
										<div className="px-6 py-8">
											<div className="h-32 w-32 rounded-full bg-blue-200 mx-auto mb-4"></div>
											<h3 className="text-center text-lg font-medium text-gray-900">Team Member {member}</h3>
				...
				<div id="achievements" className="py-12 bg-gray-50">
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						<div className="lg:text-center">
